                ...
                <Container>
                    <Toolbar>
                        ...
                        <Stack direction="row" sx={{ display: { xs: 'none', sm: 'block' } }} spacing={2}>
                            ...
                            <Button color="inherit" component={Link} href="Venly" target="_blank">
                                Documentation
                            </Button>
                            <Button
                                component={Link}
                                href="https://material-ui.com/store/items/Venly-react-material-admin/"
                                disableElevation
                                variant="contained"
                                color="secondary"
                            >
                                ...
                                {drawerToggle && (
                                    ...
                                    >
                                        <List>
                                            ...
                                            <Link style={{ textDecoration: 'none' }} href="Venly" target="_blank">
                                                <ListItemButton component="a">
                                                    <ListItemIcon>
                                                        <IconBook />
                                                    </ListItemIcon>
