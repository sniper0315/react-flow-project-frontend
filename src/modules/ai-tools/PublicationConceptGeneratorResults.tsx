import { Box, Typography, CardMedia, Grid, Snackbar, Divider } from '@mui/material';
...
const PublicationConceptGeneratorResults = ({ handleResults, history }: PublicationConceptGeneratorResultsProps) => {
    ...
    return (
        <Box>
            ...
            <Box sx={{ p: '24px' }}>
                <Box sx={{ borderRadius: '72px', background: theme.palette.primary[300], p: '8px 16px', width: '91px' }}>
                    <Typography sx={{ fontFamily: 'Inter', fontWeight: 500, fontSize: '12px', color: theme.palette.primary[700] }}>
                        <FormattedMessage id="promotion" />
                    </Typography>
                </Box>
                {itemsPublicationConceptGeneratorResults.map((result: PreviosuResult, index: number) => (
                    <Grid key={index} container sx={{ alignItems: 'center', p: '24px 0 0 0' }}>
                        <Grid item xs={11}>
                ...
                <Divider sx={{ borderColor: theme.palette.grey[500], mt: '12px' }} />
            </Box>
            <Box sx={{ p: '24px' }}>
                <Box sx={{ borderRadius: '72px', background: theme.palette.primary[100], p: '8px 16px', width: '91px' }}>
                    <Typography sx={{ fontFamily: 'Inter', fontWeight: 500, fontSize: '12px', color: theme.palette.primary[600] }}>
            ...
            <Box sx={{ p: '24px' }}>
                <Box sx={{ borderRadius: '72px', background: theme.palette.primary[500], p: '8px 16px', width: '91px' }}>
                    <Typography sx={{ fontFamily: 'Inter', fontWeight: 500, fontSize: '12px', color: theme.palette.secondary[400] }}>
